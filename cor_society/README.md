...
- Adds a global `Player Dynasty Tree` action that opens the current player dynasty in the graphical Society tree and can backfill missing dead parents and grandparents.
